...
const IconCard = ({ icon, title, description, index }) => {
  ...
  return (
    ...
    >
      ...
      >
        <motion.img src={icon} className="w-6 h-6" alt={title} />
      </motion.div>
      <div className="pt-8 pb-8">
        <div className="text-2xl pb-4 leading-tight text-white">{title}</div>
        <div className="text-sm max-w-[25rem] font-normal text-white">
          {description}
        </div>
      </div>
    ...
    <div className="relative mx-auto pb-16 px-4 py-12 space-y-12 bg-[#041527]">
      ...
      >
        <AnimatedCard index={0}>
          <div className="p-5 text-white">
            <h2 className="text-xl font-bold">Customizable Messenger</h2>
      ...
      >
        ...
        <IconCard
          icon={icon2}
          title="Omnichannel Messaging"
          description="Support customers using their preferred channel—email, SMS, social, and more."
          index={1}
        />
        <IconCard
          icon={icon3}
          title="Phone"
          description="Centralize phone support using integrations (more coming soon)."
          index={2}
        />
        <IconCard
          icon={icon4}
          title="Switch"
          description="Let customers switch to messaging mid-call to reduce phone wait times."
          index={3}
        />
      </motion.div>
      ...
      >
        ...
        <blockquote className="text-xl font-normal text-white">
          ...
          <span className="font-bold text-[#4DA8FF] ml-1">
            take a data-driven approach
          </span>{" "}
          to continuously improving our service.&quot;
        </blockquote>
        <div className="flex items-center justify-center">
          <img
            src={avater}
            ...
            alt="Oda Skuggedal Wilhelmsen"
          />
          <div className="pl-4 text-left text-white">
            <div className="font-semibold">Oda Skuggedal Wilhelmsen</div>
            <div className="text-sm">Nordic Customer Service Manager</div>
          </div>
        </div>
      </motion.div>
      ...
      {/* Bottom wave */}
      <div className="absolute bottom-[-0.1rem] left-0 w-full">
        <img src={b} alt="Bottom Wave" className="w-full" />
      </div>
    </div>
  );
};
